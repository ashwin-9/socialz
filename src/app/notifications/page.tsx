                    ...
                    <ScrollArea className="h-[calc(100vh-12rem)]">
                        {notifications.length === 0 ? (
                            ...
                            notifications.map(notification => (
                                <div
                                    key={notification.id}
                                    className={`flex items-start gap-4 p-4 border-b hiver:bg-muted/25 transition:colors ${
                                ...
                                >
                                    ...
                                    <div className="flex-1 space-y-1">
                                        ...
                                        <p className="text-sm text-muted-foreground p1-6">
